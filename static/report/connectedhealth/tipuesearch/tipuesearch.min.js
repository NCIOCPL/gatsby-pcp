(function ($) {
	$.fn.tipuesearch = function (options) {
		var set = $.extend({ show: 7, newWindow: false, showURL: true, showTitleCount: true, minimumLength: 3, descriptiveWords: 25, highlightTerms: true, highlightEveryTerm: false, mode: 'static', liveDescription: '*', liveContent: '*', contentLocation: 'tipuesearch/tipuesearch_content.json', debug: false }, options);
