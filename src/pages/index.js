		...
		<Layout>
			<div>
				...
				<div className="featured-homepage-box">
					...
					<SingleHomepageBox url="/ncp/reports/pcp-initial-assessment-of-ncp/" source="Reports_Feature_Card_Thumbnail_401x358.jpg" alt="" title="New Report from the President’s Cancer Panel" description="This report features findings from our initial assessment of the National Cancer Plan and highlights recommendations in five priority areas to accelerate progress toward the Plan’s goals."></SingleHomepageBox>
