		...
		<Layout>
			<div>
				...
				<div className="featured-homepage-box">
					...
					<SingleHomepageBox url="/about/blogs/national-cancer-plan-stakeholder-meeting/" source="stakeholder-meeting-card.png" alt="" title="National Cancer Plan Stakeholder Meeting" description="On September 7th, the Panel convened a meeting with stakeholders from across the cancer community to highlight progress towards the National Cancer Plan’s goals and discuss opportunities for improvement. Check out our latest blog for a meeting recap and learn more about the Panel’s next steps."></SingleHomepageBox>
				</div>
			</div>
		</Layout>
	);
